          ...
          <div className="container">
            ...
            <Switch>
              ...
              <Route exact path="/" render={() =>
                <Redirect to='/hairstyles' />
              } />
  
              <Route exact path="/hairstyles" render={() =>
                (this.state.loading)
                  ? <p>Loading...</p>
                  : <Gallery pictures={this.state.hairstylesResults} query='hairstyles' />
              } />
              <Route exact path="/gymnastics" render={() =>
                (this.state.loading)
                  ? <p>Loading...</p>
                  : <Gallery pictures={this.state.gymnasticsResults} query='gymnastics' />
              } />
              <Route exact path="/cruises" render={() =>
                (this.state.loading)
                  ? <p>Loading...</p>
                  : <Gallery pictures={this.state.cruisesResults} query='cruises' />
              } />
